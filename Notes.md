...
- Added LCD1602 Module (screen) as I wanted a way to see the settings without having to rely on a computer or other monitor. I used the tutorial and claude to help connect the pins. Had to use pins A2-A5 since I ran out of other pins ( only 4 and 7 left)
